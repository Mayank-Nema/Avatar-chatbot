...
### 1. Clone Repository
```bash
git clone https://github.com/Mayank-Nema/Avatar-chatbot.git
...
Project Link: [https://github.com/Mayank-Nema/Avatar-chatbot](https://github.com/Mayank-Nema/Avatar-chatbot)
